...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'createListing',
          path: '/createListing',
          builder: (context, params) => const CreateListingWidget(),
        ),
        FFRoute(
          name: 'listingDetail',
          path: '/listingDetail',
          ...
          builder: (context, params) => ListingDetailWidget(
        ...
        FFRoute(
          name: 'myListing',
          path: '/myListing',
          builder: (context, params) => const MyListingWidget(),
        ),
        FFRoute(
          name: 'howToPhoto',
          path: '/howToPhoto',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'howToPhoto')
              : const HowToPhotoWidget(),
        )

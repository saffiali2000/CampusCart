...
class UsersRecord extends FirestoreRecord {
  ...
  // "university_College" field.
  String? _universityCollege;
  String get universityCollege => _universityCollege ?? '';
  bool hasUniversityCollege() => _universityCollege != null;
  ...
  void _initializeFields() {
    ...
    _universityCollege = snapshotData['university_College'] as String?;
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        e1?.universityCollege == e2?.universityCollege &&

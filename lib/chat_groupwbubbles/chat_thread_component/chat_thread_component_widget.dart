                    ...
                    return Container(
                      ...
                      child: wrapWithModel(
                        ...
                        child: ChatThreadUpdateWidget(
                          key: Key(
                            'Keysx3_${listViewChatMessagesRecord.reference.id}',
                          ),
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      ...
                                      if (_model.uploadedFileUrl != '') {
                                        ...
                                        _model.newChat3 = ChatMessagesRecord
                                            .getDocumentFromData(
                                        ...
                                        _model.newChat4 = ChatMessagesRecord
                                            .getDocumentFromData(
                                                createChatMessagesRecordData(
                                                  user: currentUserReference,
                                                  chat: widget
                                    ...
                                    onPressed: () async {
                                      ...
                                      try {
                                        ...
                                        if (_model.uploadedFileUrl != '') {
                                          ...
                                          _model.newChat2 = ChatMessagesRecord
                                              .getDocumentFromData(
                                                  createChatMessagesRecordData(
                                                    user: currentUserReference,
                                                    chat: widget
